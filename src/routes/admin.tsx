        ...
        <main className="flex-1 space-y-8">
            ...
            <>
              ...
              <div className="grid gap-6 md:grid-cols-4">
                {[
                  ...
                  <div key={c.label} className="rounded-lg border border-forest/5 bg-card p-6">
              ...
              <div className="grid gap-6 md:grid-cols-3">
                {[
                  ...
                  <div key={s.name} className="rounded-lg border border-forest/5 bg-card p-6">
          ...
          {tab === "orders" && (
            <>
              ...
              <div className="overflow-x-auto rounded-lg border border-forest/5 bg-card">
                  ...
                  <tbody className="divide-y divide-forest/5">
                    {orders.map((o) => (
                      <tr key={o.id}>
                        ...
                        <td className="p-4">
                          <span className="border border-sand/40 bg-sand/15 px-2 py-0.5 text-[10px] text-sand">
                            {o.status}
                          </span>
                        </td>
                      </tr>
          ...
          {tab === "line" && (
            <>
              ...
              <div className="max-w-2xl space-y-6 rounded-lg border border-forest/5 bg-card p-8">
...
function SettingCard({
  ...
  return (
    <div className="space-y-6 rounded-lg border border-forest/5 bg-card p-8">
      ...
      <button
        type="button"
        className="rounded-sm bg-forest px-6 py-2.5 text-xs font-bold uppercase tracking-widest text-cream transition-colors hover:bg-moss"
      >
        儲存設定
      </button>
    </div>
